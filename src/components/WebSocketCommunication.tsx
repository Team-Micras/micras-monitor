...
export const WebSocketCommunication: React.FC<WebSocketCommunicationProps> = ({
  ...
  console.log('WebSocketCommunication component initialized with URL:', url);
  ...
  return (
    <div className="websocket-communication">
      ...
      <div className="connection-controls">
        ...
        {!isWebSocketConnected ? (
          <button onClick={handleConnect} disabled={isConnecting || !webSocketService}>
            {isConnecting ? 'Connecting...' : 'Connect to WebSocket'}
          </button>
        ) : (
          <button onClick={handleDisconnect} disabled={!webSocketService}>
            Disconnect
          </button>
        )}
      </div>
